...
export const API_ENDPOINTS = {
    ...
    ADMIN: "https://script.google.com/macros/s/AKfycbx5MM62MDTLO8GKh8qv7oFhFwo7h-JStfXigYUqhmZUY1W5YzJN2_zh4r-8nZkIbeqd/exec" // Microservicio exclusivo de administración
};
...
export const ACTION_TO_SERVICE_MAP = {
    ...
    'backupDatabase': 'ADMIN', 'restoreDatabase': 'ADMIN', 'backupDrive': 'ADMIN', 'restoreDrive': 'ADMIN',
    'organizeDatabase': 'ADMIN', 'normalizeImageNames': 'ADMIN', 'reorganizeImagesInDrive': 'ADMIN',
    'addCorteSilent': 'ADMIN', 'registerBrandLogo': 'ADMIN', 'updateCorteField': 'ADMIN',
    'logFrontend': 'LEGACY'
};
